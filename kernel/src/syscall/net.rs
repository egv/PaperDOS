...
pub extern "C" fn pd_net_wifi_connect(_ssid: *const u8, _ssid_len: usize,
    _pass: *const u8, _pass_len: usize) -> i32 { -1 }
pub extern "C" fn pd_net_wifi_disconnect() -> i32 { -1 }
pub extern "C" fn pd_net_wifi_status() -> i32 { -1 }

pub extern "C" fn pd_net_http_get(
    _url: *const u8, _url_len: usize,
    _buf: *mut u8, _buf_len: usize,
) -> i32 { -1 }
pub extern "C" fn pd_net_http_post(
    _url: *const u8, _url_len: usize,
    _body: *const u8, _body_len: usize,
    _buf: *mut u8, _buf_len: usize,
) -> i32 { -1 }
pub extern "C" fn pd_net_http_begin(_url: *const u8, _url_len: usize) -> i32 { -1 }
pub extern "C" fn pd_net_http_set_header(
    _session: i32,
    _name: *const u8, _name_len: usize,
    _value: *const u8, _value_len: usize,
) -> i32 { -1 }
pub extern "C" fn pd_net_http_send(_session: i32) -> i32 { -1 }
pub extern "C" fn pd_net_http_read(_session: i32, _buf: *mut u8, _len: usize) -> i32 { -1 }
