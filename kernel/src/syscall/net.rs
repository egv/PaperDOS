...
pub extern "C" fn pd_net_wifi_disconnect() -> i32 {
    -1
}
pub extern "C" fn pd_net_wifi_status() -> i32 {
    -1
}
...
pub unsafe extern "C" fn pd_net_http_begin(_url: *const u8, _url_len: usize) -> i32 {
    -1
}
...
pub extern "C" fn pd_net_http_send(_session: i32) -> i32 {
    -1
}

/// # Safety
/// `buf` must be valid for `len` bytes of writes.
pub unsafe extern "C" fn pd_net_http_read(_session: i32, _buf: *mut u8, _len: usize) -> i32 {
    -1
}

pub extern "C" fn pd_net_http_status_code(_session: i32) -> i32 {
    -1
}
pub extern "C" fn pd_net_http_end(_session: i32) -> i32 {
    -1
}
