...
fn syscall_table_net_fields_populated_syscall_mem_net_font() {
    ...
    assert_eq!(
        t.net_wifi_disconnect,
        pd_net_wifi_disconnect as usize as u32
    );
    ...
    assert_eq!(
        t.net_http_set_header,
        pd_net_http_set_header as usize as u32
    );
    assert_eq!(t.net_http_send, pd_net_http_send as usize as u32);
    assert_eq!(t.net_http_read, pd_net_http_read as usize as u32);
    assert_eq!(
        t.net_http_status_code,
        pd_net_http_status_code as usize as u32
    );
